...
class_list1=sorted(class_list1,key=lambda x: x[2])
class_list2=sorted(class_list2,key=lambda x: x[2])
#print(class_list1,class_list2)
group1=mn.assign_group_to_class(girls_df,class_list1)
group2=mn.assign_group_to_class(girls_df,class_list2,2)
room=list(eval(input("Enter Room list")))
...
class_list3=sorted(class_list3,key=lambda x: x[2])
class_list4=sorted(class_list4,key=lambda x: x[2])
...
alt_df=mn.room_alotment(alt_df,n_seat,room.sort())
